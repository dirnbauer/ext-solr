...
$GLOBALS['TCA']['tt_content']['columns']['CType']['config']['itemGroups']['search'] = 'solr.messages:plugin_results';

// Register the plugins
$pluginSearchSignature = ExtensionUtility::registerPlugin(
    'solr',
    'pi_search',
    'solr.messages:tt_content.CType_pi_search',
...
$pluginFrequentlySearchedSignature = ExtensionUtility::registerPlugin(
    ...
    'solr.messages:tt_content.CType_pi_frequentsearches',
    'extensions-solr-plugin-contentelement',
    'search',
);
...
$pluginResultsSignature = ExtensionUtility::registerPlugin(
    'solr',
    'pi_results',
    'solr.messages:tt_content.CType_pi_results',
    'extensions-solr-plugin-contentelement',
    'search',
    'solr.messages:plugin_results_description',
